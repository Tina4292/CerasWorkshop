...
public static class SeedData
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        List<Product> products = new List<Product>
        {
            ...
            new Product {Name = "Festive Pumpkin", Description = "Welcome the cozy vibes of fall with this handmade Crocheted Pumpkin! Crafted with soft brown yarn and topped with a vibrant green stem, this beautifully textured piece captures the essence of autumn. Perfect as seasonal decor or a thoughtful gift, this pumpkin adds warmth and charm to any space.", Price = 15, ImageURL = "img/FestivePumpking"}
